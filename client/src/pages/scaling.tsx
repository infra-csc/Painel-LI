            ...
            <div className="space-y-6">
              ...
              {selectedInclusion.needsTicket && (
                <div className="space-y-4">
                  ...
                  {/* Status e Dados da Passagem Comprada */}
                  {(() => {
                          ...
                          <>
                            ...
                            <div className="bg-white dark:bg-gray-800 border border-green-200 dark:border-green-800 rounded-lg p-3">
                              <Label className="text-sm font-medium text-green-700 dark:text-green-300 mb-2 block">
                                Dados Reais da Passagem Comprada
                              </Label>
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  <div className="space-y-2">
                                    <div className="text-sm">
                                      <span className="font-medium text-foreground">Data Ida:</span>{' '}
                                      <span className="text-muted-foreground">
                                        {ticket.actualDepartureDate ? formatDate(ticket.actualDepartureDate) : 'Não informado'}
                                      </span>
                                    </div>
                                    <div className="text-sm">
                                      <span className="font-medium text-foreground">Horário Ida:</span>{' '}
                                      <span className="text-muted-foreground">
                                        {ticket.actualDepartureTime || 'Não informado'}
                                      </span>
                                    </div>
                                    <div className="text-sm">
                                      <span className="font-medium text-foreground">Aeroporto Origem:</span>{' '}
                                      <span className="text-muted-foreground">
                                ...
                                <div>
                                  <div className="space-y-2">
                                    <div className="text-sm">
                                      <span className="font-medium text-foreground">Data Retorno:</span>{' '}
                                      <span className="text-muted-foreground">
                                        {ticket.actualReturnDate ? formatDate(ticket.actualReturnDate) : 'Não informado'}
                                      </span>
                                    </div>
                                    <div className="text-sm">
                                      <span className="font-medium text-foreground">Horário Retorno:</span>{' '}
                                      <span className="text-muted-foreground">
                                        {ticket.actualReturnTime || 'Não informado'}
                                      </span>
                                    </div>
                                    <div className="text-sm">
                                      <span className="font-medium text-foreground">Aeroporto Destino:</span>{' '}
                                      <span className="text-muted-foreground">
