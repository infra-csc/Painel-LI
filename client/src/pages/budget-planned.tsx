                          ...
                          <div className="grid grid-cols-3 gap-2">
                            ...
                            <div className="rounded-lg p-2.5 border border-indigo-100 bg-indigo-50/50">
                              <div className="flex items-center gap-1 mb-2">
                                ...
                                <span className="text-[8px] font-black text-indigo-700 uppercase min-w-0">Diárias</span>
                              </div>
                            ...
                            <div className="rounded-lg p-2.5 border border-orange-100 bg-orange-50/50">
                              <div className="flex items-center gap-1 mb-2">
                                ...
                                <span className="text-[8px] font-black text-orange-700 uppercase min-w-0">Aliment.</span>
                              </div>
                            ...
                            <div className="rounded-lg p-2.5 border border-violet-100 bg-violet-50/50">
                              <div className="flex items-center gap-1 mb-2">
                                ...
                                <span className="text-[8px] font-black text-violet-700 uppercase min-w-0">Mobilidade</span>
                              </div>
