...
import { Plane, Bus, Truck, Save, Eye, FileText, ChevronDown, ChevronRight, MessageCircle, Edit, CheckCircle, Clock, Ticket as TicketIcon, CreditCard, Paperclip, NotebookPen, ClipboardCheck, History, AlertCircle, ArrowLeftRight, CheckCheck, XCircle } from "lucide-react";
                                  ...
                                  <div className="p-3 space-y-2 bg-amber-50/30">
                                    ...
                                    {hasTicketPurchased && (
                                      <div className="flex items-center gap-1.5 bg-orange-50 border border-orange-200 rounded-lg px-2 py-1.5">
                                        ...
                                        <p className="text-[10px] text-orange-600">Esta escala possui passagem comprada. Revise os impactos antes de aprovar.</p>
                                      </div>
                                    )}
