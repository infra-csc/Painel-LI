    ...
    <div className="bg-card rounded-xl border border-border overflow-hidden">
      <div className="p-4 space-y-3">
        {carregando ? (
          ...
          <div className="text-center py-10" role="alert">
            <p className="text-sm text-muted-foreground mb-3">Não foi possível carregar as solicitações.</p>
            <button
              type="button"
              onClick={onRecarregar}
              className="inline-flex items-center gap-1.5 h-8 px-3 text-xs font-semibold text-primary border border-primary/25 rounded-lg hover:bg-brand-soft transition-colors"
          ...
          <div className="text-center py-10 px-4 rounded-xl border border-dashed border-border" data-testid="lista-vazia">
            <Luggage className="w-8 h-8 text-muted-foreground mx-auto mb-2" aria-hidden="true" />
            ...
            {totalSemFiltro > 0 && temFiltroAtivo && (
              <button
                ...
                className="mt-3 inline-flex items-center gap-1.5 h-8 px-3 text-xs font-semibold text-primary border border-primary/25 rounded-lg hover:bg-brand-soft transition-colors"
      ...
      {!carregando && !erro && linhas.length > 0 && (
        <div className="h-10 px-4 bg-surface-muted border-t border-border flex items-center gap-4 flex-wrap">
          <p className="text-xs text-muted-foreground tabular-nums" data-testid="rodape-lista">
          ...
          <p className="ml-auto text-xs text-muted-foreground font-mono" aria-live="polite">
