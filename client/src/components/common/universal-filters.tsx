      ...
      >
        ...
        {!hideStatusFilter && (
          <div>
            ...
            >
              <SelectTrigger className="!h-8 w-full border border-slate-200 rounded-lg bg-white px-3 text-sm text-slate-700 font-normal cursor-pointer hover:border-blue-300 transition-colors focus:ring-2 focus:ring-blue-200 focus:border-blue-400 py-0 [&>span]:text-slate-700 [&>span]:font-normal data-[placeholder]:text-slate-400">
