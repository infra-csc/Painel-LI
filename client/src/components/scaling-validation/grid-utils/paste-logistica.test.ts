/**
 * Colagem no formato da PLANILHA DA LOGÍSTICA (25/09 — separado de paste-parse.test.ts):
 * as duas planilhas reais, com e sem cabeçalho, e o classificador de colunas.
 */
import { describe, it, expect } from "vitest";
import { buildDateList } from "./grid-dates";
import { decomposeGridRows } from "./grid-rows";
import { functionNameKey, normalizeStr } from "./paste-values";
import { findLogisticaHeader } from "./paste-layout";
