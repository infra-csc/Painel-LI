...
import { Users, UserCheck, Plane, Hotel, Calculator, CheckCircle, Search, UserPlus, Settings, Wrench, UserCog, Calendar } from "lucide-react";
  ...
  const allTabs = [
    {
      ...
      icon: UserPlus,
      permission: "canAccessCadastros" as const,
    },
    {
      id: "events",
      path: "/events",
