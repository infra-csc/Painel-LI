      ...
      <Dialog open={open} onOpenChange={handleClose}>
        <DialogContent className="p-0 gap-0 sm:max-w-[560px] rounded-2xl border-0 shadow-2xl overflow-hidden [&>button:last-child]:hidden flex flex-col max-h-[92vh]"
          ...
          <div style={{ padding: "20px 28px", borderBottom: "1px solid #F1F5F9", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0, background: "white" }}>
            ...
            <button onClick={handleClose} style={{ width: 34, height: 34, borderRadius: "50%", border: "none", background: "transparent", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "#94A3B8" }}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                    <FormField control={form.control} name="name" render={({ field }) => (
                      <div>
                        <label style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", display: "block", marginBottom: 6, letterSpacing: "0.1em", textTransform: "uppercase" }}>
                          Nome do Evento <span style={{ color: "#EF4444" }}>*</span>
                        </label>
                        <Input placeholder="Ex: Rock in Rio 2025" data-testid="input-event-name" className={IC} {...field} />
                    ...
                    <FormField control={form.control} name="location" render={({ field }) => (
                      <div>
                        ...
                        <Input placeholder="Ex: Rio de Janeiro, RJ" data-testid="input-event-location" className={IC} {...field} />
                        <FormMessage className="text-[11px] mt-1" />
                      </div>
                    )} />
                  </div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                    <FormField control={form.control} name="startDate" render={({ field }) => (
                      <div>
                        ...
                        <div style={{ position: "relative" }}>
                          ...
                          <Input type="date" data-testid="input-event-start-date" className={IC} {...field} />
                        </div>
                        <FormMessage className="text-[11px] mt-1" />
                      </div>
                    )} />
                    <FormField control={form.control} name="endDate" render={({ field }) => (
                      <div>
                        ...
                        <div style={{ position: "relative" }}>
                          <span className="material-symbols-outlined" style={{ position: "absolute", right: 12, top: "50%", transform: "translateY(-50%)", fontSize: 16, color: "#CBD5E1", pointerEvents: "none" }}>calendar_today</span>
                          <Input type="date" data-testid="input-event-end-date" className={IC} {...field} />
                        </div>
                        <FormMessage className="text-[11px] mt-1" />
                      </div>
                    )} />
                  ...
                  {isEditing && (
                    <FormField control={form.control} name="status" render={({ field }) => (
                      <div>
                        <label style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", display: "block", marginBottom: 6, letterSpacing: "0.1em", textTransform: "uppercase" }}>Status</label>
                  ...
                  <div style={{ background: "#F8FAFC", borderRadius: 12, padding: "16px 18px", border: "1px solid rgba(226,232,240,0.5)" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 10 }}>
                      ...
                      <FormField control={form.control} name="paymentCompanyCnpj" render={({ field }) => (
                        <div>
                          <label style={{ fontSize: 10, fontWeight: 700, color: "#94A3B8", display: "block", marginBottom: 5, textTransform: "uppercase", letterSpacing: "0.07em" }}>CNPJ</label>
                          <FormControl>
                  ...
                  <FormField control={form.control} name="observations" render={({ field }) => (
                    <div>
                      ...
                      <FormControl>
                        <Textarea rows={3} maxLength={500} placeholder="Notas adicionais, requisitos específicos..."
